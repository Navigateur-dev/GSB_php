...
<form action="index.php?action=ajoutDemRembTrait" method='post'>
    <div class="row mb-3">
        ...
        <div class="col-sm-12">
            <input type="text" class="form-control" name="montant" value="<?php if (isset($laDemande) == true) echo $laDemande->getMontant(); ?>" id="montant">
        </div>
    </div>
    <div class="row mb-3">
        ...
        <div class="col-sm-12">
            ...
            <select class="form-select form-select-md" name="typeFrais">
                <?php foreach ($lesTypesFrais as $unType) {
                    ...
                    if (isset($unType) == true && $unType == $unType->getId())
