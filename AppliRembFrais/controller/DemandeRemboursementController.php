...
class DemandeRemboursementController extends Controller
{
    ...
    public function ajoutDemandeRemboursementTrait()
    {
        ...
        $typeFraisRepository = new TypeFraisRepository();
        $lesTypesFrais = $typeFraisRepository->getLesTypesFrais();
        $this->render("demandeRemboursement/ajoutDemande", array("title" => "Ajout d'une demande de remboursement", "lesTypesFrais" => $lesTypesFrais, "laDemande" => $laDemande, "msg" => $msg));
    }
    ...
    public function consultLesDemandeRemboursement()
    {
        session_start();

        $unDemRemboursRepository = new DemandeRemboursementRepository();
        $lesDemandes = $unDemRemboursRepository->getLesDemandesRemboursement();

        $this->render("demandeRemboursement/consultToutesDemandeListe", array("title" => "Liste des demandes de remboursement", "lesDemandes" => $lesDemandes));
    }
};
