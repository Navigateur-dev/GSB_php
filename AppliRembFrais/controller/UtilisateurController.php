...
class UtilisateurController extends Controller
{
    public function __construct()
    {
        ...
        require_once(ROOT . '/model/repository/ProfilRepository.php');
    ...
    {   session_start();
        ...
        $lesProfils = $profilRepository->getLesProfils();
        

        $this->render("utilisateur/ajoutUtilisateur", array("title" => "Ajout d'un utilisateur", "lesProfils" => $lesProfils));
    }
    public function ajoutUtilisateurTrait()
    {
        ...
        $profilRepository = new ProfilRepository();
        $lesProfils = $profilRepository->getLesProfils();
        $this->render("utilisateur/ajoutUtilisateur", array("title" => "Ajout d'un utilisateur", "lesProfils" => $lesProfils, "unUtilisateur" => $unUtilisateur, "msg" => $msg));
    }
    public function consultUtilisateur()
    {
        session_start();
        $idUtilConnecte = $_SESSION["id"];
        $unUtilisateurRepository = new UtilisateurRepository();
        $monUtilisateur = $unUtilisateurRepository->getMonUtilisateur($idUtilConnecte);
        $this->render("utilisateur/consultUtilisateur", array("title" => "Consultation du profil", "monUtilisateur" => $monUtilisateur));
    }
