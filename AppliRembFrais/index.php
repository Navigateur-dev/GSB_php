...
if (isset($_GET['action'])) {
    switch ($_GET['action']) {
        ...
        case "consultProfil":
            ...
            require_once(ROOT . "/controller/UtilisateurController.php");
            $leControleur = new UtilisateurController();
            $leControleur->consultUtilisateur();
            break;
        ...
        case "connexionTrait":
            ...
            break;
        case "consultTousRembour":
            // vérifie l'ensemble des remboursements
            require(ROOT . "/controller/Controller.php");
            require(ROOT . "/controller/DemandeRemboursementController.php");
            $leControleur = new DemandeRemboursementController();
            $leControleur->consultLesDemandeRemboursement();
            break;
